...
interface UserSlice {
    ...
    setHasGrantedPermissions: (hasGrantedPermissions: boolean) => void
    resetUser: () => void
}
...
const initialUserState = {
    ...
    hasGrantedPermissions: false as boolean,
}
...
> = (set) => {
    ...
    return {
        ...
        setHasGrantedPermissions: (hasGrantedPermissions: boolean) =>
